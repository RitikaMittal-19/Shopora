                ...
                await toast.promise(
                    axios.post('/api/store/ai',{base64Image: base64String, mimeType}, {headers: { Authorization: `Bearer ${token}` }}),
                    {
                        ...
                        success: (res) => {
                                    ...
                                    // ✅ NEW: handle quota / AI down case
                                    if (data.aiUnavailable) {
                                        setAiUsed(true); // prevent repeated retries
                                        return "AI Limited currently— fill details manually";
                                    }
                                    ...
                                    if (data.name && data.description) {
                                        ...
                                        setAiUsed(true);
                                        return "AI filled product details";
                                    }
