    ...
    const linkSections = [
        {
            ...
            links: [
                ...
                { text: "BEAUTY", path: '/', icon: null },
                { text: "HEALTH", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
            links: [
                ...
                { text: "Privacy Policy", path: '/about', icon: null },
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+9876543210", path: '/contact', icon: MailIcon },
                { text: "support@shopora.com", path: '/contact', icon: PhoneIcon },
                { text: "Jaipur, Rajasthan", path: '/contact', icon: MapPinIcon }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to shopora, your ultimate destination for the latest and smartest products. From any and every essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © shopora All Right Reserved.
                </p>
            </div>
        </footer>
    );
